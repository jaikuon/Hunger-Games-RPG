#Jaikuons Hunger Games Simulation!
#Inspired by Brantsteeles version
#This version of the hunger games will have some features I walways desired from the site over the years using it
#1. Alliances
#2. Time limits
#3. Fights, Items, and Interactions will actually effect a players chances of survival
#4. People can make builds of specific characters based on rpg elements
#Current plans - Make basic gui version of this before goign to game timeline


#Game Timeline
#1. Add neutral events 2. Tweak probability chnace
#
#
#
#
